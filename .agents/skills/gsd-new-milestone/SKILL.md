...
description: "Migrated Claude /gsd workflow for `new-milestone`. Use when you want to follow the original get-shit-done workflow in Codex."
---
...
- `/home/vscode/.claude/get-shit-done/workflows/new-milestone.md`
