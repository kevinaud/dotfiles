...
description: "Migrated Claude /gsd workflow for `discovery-phase`. Use when you want to follow the original get-shit-done workflow in Codex."
---
...
- `/home/vscode/.claude/get-shit-done/workflows/discovery-phase.md`
