---
name: gsd-plan-phase
description: "Migrated Claude /gsd workflow for `plan-phase`. Use when you want to follow the original get-shit-done workflow in Codex."
---
...
- `/home/vscode/.claude/get-shit-done/workflows/plan-phase.md`
