...
description: "Migrated Claude /gsd workflow for `verify-work`. Use when you want to follow the original get-shit-done workflow in Codex."
---
...
- `/home/vscode/.claude/get-shit-done/workflows/verify-work.md`
