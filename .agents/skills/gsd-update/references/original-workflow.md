...
if [ -f ./.claude/get-shit-done/VERSION ]; then
  ...
  INSTALL_FLAG="--local"
elif [ -f /home/vscode/.claude/get-shit-done/VERSION ]; then
  INSTALL_TYPE="global"
...
- /home/vscode/.claude/commands/gsd/ wiped and replaced
- /home/vscode/.claude/get-shit-done/ wiped and replaced
...
rm -f /home/vscode/.claude/cache/gsd-update-check.json
```
