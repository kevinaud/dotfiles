---
description: Analyzes Python package and module organization for cohesion, dependency direction, and architectural clarity. Produces actionable recommendations without modifying code.
mode: subagent
tools:
  bash: true
  read: true
