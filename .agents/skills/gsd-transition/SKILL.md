---
name: gsd-transition
description: "Migrated Claude /gsd workflow for `transition`. Use when you want to follow the original get-shit-done workflow in Codex."
---
...
- `/home/vscode/.claude/get-shit-done/workflows/transition.md`
