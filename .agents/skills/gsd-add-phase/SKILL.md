---
name: gsd-add-phase
description: "Migrated Claude /gsd workflow for `add-phase`. Use when you want to follow the original get-shit-done workflow in Codex."
---
...
- `/home/vscode/.claude/get-shit-done/workflows/add-phase.md`
