...
@/home/vscode/.claude/get-shit-done/references/git-integration.md
</required_reading>
...
See `/home/vscode/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
</tdd_plan_execution>
...
See /home/vscode/.claude/get-shit-done/references/checkpoints.md for complete checkpoint guidance.
</step>
...
Create `.planning/phases/XX-name/{phase}-USER-SETUP.md` using template from `/home/vscode/.claude/get-shit-done/templates/user-setup.md`.
...
Use /home/vscode/.claude/get-shit-done/templates/summary.md for structure.
