...
description: "Migrated Claude /gsd workflow for `plan-milestone-gaps`. Use when you want to follow the original get-shit-done workflow in Codex."
---
...
- `/home/vscode/.claude/get-shit-done/workflows/plan-milestone-gaps.md`
