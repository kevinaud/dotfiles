...
description: "Migrated Claude /gsd workflow for `list-phase-assumptions`. Use when you want to follow the original get-shit-done workflow in Codex."
---
...
- `/home/vscode/.claude/get-shit-done/workflows/list-phase-assumptions.md`
