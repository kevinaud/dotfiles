...
description: "Migrated Claude /gsd workflow for `complete-milestone`. Use when you want to follow the original get-shit-done workflow in Codex."
---
...
- `/home/vscode/.claude/get-shit-done/workflows/complete-milestone.md`
